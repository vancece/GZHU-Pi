...
type TUser struct {
	...
	MinappID  null.Int       `json:"minapp_id,omitempty" remark:"知晓云用户id" gorm:"type:real"`
	Openid    null.String    `json:"openid,omitempty" remark:"微信openid" gorm:"type:varchar"`
	Unionid   null.String    `json:"unionid,omitempty" remark:"微信unionid" gorm:"type:varchar"`
	StuID     null.String    `json:"stu_id,omitempty" remark:"学号" gorm:"type:varchar"`
	RoleID    null.String    `json:"role_id,omitempty" remark:"用户角色id" gorm:"type:real"`
	...
	Gender    null.Int       `json:"gender,omitempty" remark:"性别" gorm:"type:real"`
