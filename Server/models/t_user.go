...
type TUser struct {
	...
	MinappID  sql.NullInt64  `json:"minapp_id" remark:"知晓云用户id" gorm:"type:real"`
	Openid    sql.NullString `json:"openid" remark:"微信openid" gorm:"type:varchar"`
	Unionid   sql.NullString `json:"unionid" remark:"微信unionid" gorm:"type:varchar"`
	...
	Phone     sql.NullString `json:"phone" remark:"手机号码" gorm:"type:varchar"`
